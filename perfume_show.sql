...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2024 at 07:08 PM
...
(295, 2, 'hoang', 'hoang@gmail.com', '091111111', ' Hà nội', 1, 249000, 0, '2024-08-07', 'gôd', 1),
(296, 2, 'hoang', 'hoang@gmail.com', '091111111', ' Hà nội', 2, 249000, 0, '2024-08-07', 'ddddddddddddddddđ', 1),
(297, 2, 'hoang', 'hoang@gmail.com', '091111111', ' Hà nội', 1, 11750000, 0, '2024-08-08', 'ddddddddddđ', 1);
...
--
-- Table structure for table `sanpham_thetich`
--
...
--
-- Dumping data for table `sanpham_thetich`
--
...
(1, 'admin', 'admin1@fpt.edu.vn', '099999999999', '123', 'Nam Định', 1),
(2, 'hoang', 'hoang@gmail.com', '091111111', '123', ' Hà nội', 0),
(3, 'hoang', 'hoanghdph33436@fpt.edu.vn', '012345', '123456', 'Tu hOàng,Hà Nội', 1);

-- --------------------------------------------------------

--
-- Table structure for table `thetich`
--
...
--
-- Dumping data for table `thetich`
--
...
--
-- Indexes for table `sanpham_thetich`
--
...
--
-- AUTO_INCREMENT for table `sanpham_thetich`
--
ALTER TABLE `sanpham_thetich`
...
--
-- AUTO_INCREMENT for table `thetich`
--
ALTER TABLE `thetich`
...
--
-- Constraints for table `sanpham_thetich`
--
ALTER TABLE `sanpham_thetich`
